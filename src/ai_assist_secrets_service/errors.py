...
class SecretErrorCodes:
    ...
    PLATFORM_PROVIDER_SECRET_NOT_CONFIGURED = "PLATFORM_PROVIDER_SECRET_NOT_CONFIGURED"
    PLATFORM_PROVIDER_SECRET_ACCESS_DENIED = "PLATFORM_PROVIDER_SECRET_ACCESS_DENIED"
    PLATFORM_PROVIDER_SECRET_INVALID = "PLATFORM_PROVIDER_SECRET_INVALID"
    PLATFORM_PROVIDER_SECRET_VALIDATION_FAILED = "PLATFORM_PROVIDER_SECRET_VALIDATION_FAILED"
    PLATFORM_PROVIDER_QUOTA_NOT_CONFIGURED = "PLATFORM_PROVIDER_QUOTA_NOT_CONFIGURED"
    PLATFORM_PROVIDER_QUOTA_DENIED = "PLATFORM_PROVIDER_QUOTA_DENIED"
    PLATFORM_PROVIDER_AUDIT_NOT_CONFIGURED = "PLATFORM_PROVIDER_AUDIT_NOT_CONFIGURED"
